...
Python-скрипт для резервного копирования сообщений и медиафайлов из Telegram-каналов. Работает на базе библиотеки [Telethon](https://github.com/LonamiWebs/Telethon). По завершению экспорта будет создан локальный веб сайт для удобного чтения и поиска по материалам. 
...
- **Автоматическая генерация HTML** - тексты канала с хронологией, поиском и воспроизведением медиа файлов
...
- `channel_dump/index.html` - локальный веб сайт с содержимым канала
